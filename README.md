...
4. [Scala Cheatsheet](#scala-cheatsheet)
   ...
   - [Специфические случаи](#специфические-случаи)
...
- **HEAD** можно переносить на конкретный коммит:
  - `^` - штука для перехода не по хешу коммита, а просто на один назад. Например, `git checkout HEAD^` перенесет нас на один коммит назад.
  - `~` - штука для перемещения нескольких коммитов назад. Например, `git checkout HEAD~4`.
...
(Здесь можно добавить основные команды и примеры использования Scala для простых случаев)

### Специфические случаи

(Здесь можно добавить команды и примеры использования Scala для более сложных и специфических случаев)
